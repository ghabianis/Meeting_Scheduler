...
![Landing Page Image](https://raw.githubusercontent.com/ghabianis/Developer-Advocate-Test/master/images/3.png)
...
✅ **Sign in with Google** - One click, no passwords to remember <br>
✅ **Create meetings instantly** - Form fills out in seconds <br>
✅ **Automatic Meet links** - No manual setup needed<br>
✅ **Dashboard overview** - See all your meetings at a glance<br>
✅ **Smart filtering** - Find upcoming meetings fast<br>
✅ **Edit meetings** - Change details if plans shift<br>
✅ **Delete safely** - Can't accidentally lose a meeting<br>
